...
if (document.getElementById("producto_"+i).checked == true){
	var nuevaVenta = new objVenta(almacenProductos[i], document.getElementById("txtCantidad_"+i).value);
   almacenVentas.push(nuevaVenta);
	}
   }   
 }
  //alert (producto);
...
for (var i = 0; i< almacenVentas.length; i++){
    ventana.document.write("<tr>");
    ventana.document.write("<td>");
    ventana.document.write(almacenVentas[i].unidades);
    ventana.document.write("</td>");
    ventana.document.write("<td>");
    ventana.document.write(almacenVentas[i].producto);
    ventana.document.write("</td>");
