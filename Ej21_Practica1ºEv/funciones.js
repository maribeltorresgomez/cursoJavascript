function verCapa (ver, ocultar, ocultar2,ocultar3){ 		
...
function asignarExpediente(){
   ...
   document.getElementById('nexpediente').value= contador + 1002; //Empiezo a contar desde 1000 los expedientes
...
if(nombre.value == "" || apellido1.value == "" || apellido2.value == "" || dni.value == ""){
...
function nonumeros(evento){ //para verlo en todos los navegadores
...
verCapa(capa3, capa1, capa2,capa0);
