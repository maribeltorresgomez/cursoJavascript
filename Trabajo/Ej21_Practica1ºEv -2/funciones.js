...
function imprimeAlumno(){
	...
	ventana.document.write(matricula.alumno.Nombre+ "<br>");

	for (var i = 0; i< matricula.alumno.Modulos.length; i++){
	ventana.document.write(matricula.alumno.Modulos[i].NombreModulo +"<br>");
...
function ponbotonAlumno(){	
	...
	for (var i =0; i< almacenMatriculas.length; i++){
	cadena = cadena + "<button type='button' name='alumno"+i+"' id='alumno"+i+"' >Expediente: " + almacenMatriculas[i].alumno.NExp + "</button>";
	}	
